...
for line in plt.gca().get_lines():
    y = line.get_ydata()
    x = line.get_xdata()
    mode = 'lines' if line.get_label() == 'ZHVI Average' else 'markers'
    name = line.get_label()
